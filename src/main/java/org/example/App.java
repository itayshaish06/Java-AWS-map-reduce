...
public class App {
    ...
    public static void main(String[]args){
        if(args.length < 2){
                System.err.println("did not receive enough arguments");
                System.exit(-1);
        }
        ...
        HadoopJarStepConfig step1 = new HadoopJarStepConfig()
                .withJar("s3://bucket1638974297771/jars/Step1.jar")
                .withMainClass("Step1");
        ...
        HadoopJarStepConfig step2 = new HadoopJarStepConfig()
                .withJar("s3://bucket1638974297771/jars/Step2.jar")
                .withMainClass("Step2");
        ...
        HadoopJarStepConfig step3 = new HadoopJarStepConfig()
                .withJar("s3://bucket1638974297771/jars/Step3.jar")
                .withMainClass("Step3");
        ...
        HadoopJarStepConfig step4 = new HadoopJarStepConfig()
                .withJar("s3://bucket1638974297771/jars/Step4.jar")
                .withMainClass("Step4");
        ...
        HadoopJarStepConfig step5 = new HadoopJarStepConfig()
                .withJar("s3://bucket1638974297771/jars/Step5.jar")
                .withMainClass("Step5")
        ...
        RunJobFlowRequest runFlowRequest = new RunJobFlowRequest()
                ...
                .withLogUri("s3://bucket1638974297771/logs/")
